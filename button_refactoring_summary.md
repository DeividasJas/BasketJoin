...
9.  **[completed]** Refactor remaining buttons found in the global search:
    ...
    - **[completed]** `src/app/(with-layout)/dashboard/locations/page.tsx` (2 buttons: back link + create button)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/page.tsx` (2 buttons: back link + add button)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/new/page.tsx` (1 back link)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/[id]/edit/page.tsx` (1 back link)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/[id]/edit/page.tsx` (1 back link)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/[id]/reschedule/page.tsx` (1 back link)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/[id]/change-location/page.tsx` (1 back link)
    - **[completed]** `src/app/(with-layout)/dashboard/locations/[id]/games/page.tsx` (2 links: back + view details)
...
2. **Action navigation → `<Button variant="outline" asChild><Link>`**
   ...
   <Button variant="outline" asChild>
     <Link href="/dashboard/locations/new">➕ Create New Game</Link>
   </Button>
   ```

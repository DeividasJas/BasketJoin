...
export const registerToGame = async (gameId: number): Promise<RegisterToGameResult> => {
  try {
    const user_id = await getUserId()
...
export const cancelRegistration = async (gameId: number): Promise<CancelRegistration> => {
  try {

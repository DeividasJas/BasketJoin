...
export default async function AdminGamesPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
  ...
  const { games, totalGames, allLeagues, page: currentPage, pageSize: currentPagesize } = await getAllGamesForAdmin(page, pageSize, { status, leagueId })
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-lg font-semibold text-zinc-800 dark:text-zinc-100">Games</h1>
      ...
      <AdminGamesList games={games} pageSize={currentPagesize} allLeagues={allLeagues} currentStatus={status} currentLeagueId={leagueId} />

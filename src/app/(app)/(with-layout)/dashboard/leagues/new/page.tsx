...
export default async function NewLeaguePage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
      ...
      <div>
        <h1 className="text-lg font-semibold text-zinc-800 dark:text-zinc-100">New League</h1>
        <p className="mt-0.5 text-xs text-zinc-500 dark:text-zinc-400">Configure schedule and payment settings</p>
      </div>

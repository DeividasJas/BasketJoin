    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700/60 dark:bg-zinc-900">
          ...
          {overdueSchedules > 0 && (
            <p className="mt-1 text-[10px] tabular-nums text-red-500">
      ...
      <div className="flex flex-wrap gap-3">
        {(["PLAYER", "ORGANIZER", "ADMIN"] as const).map((role) => (
          <div
            key={role}
            className="flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 dark:border-zinc-700/60 dark:bg-zinc-900"
          >
            <span className="text-[10px] font-semibold uppercase tracking-wide text-zinc-400 dark:text-zinc-500">
              {role}
            </span>
            <span className="text-sm font-extralight tabular-nums text-zinc-800 dark:text-zinc-100">

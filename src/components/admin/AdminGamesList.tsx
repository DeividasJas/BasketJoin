...
import { MapPin, Users, Trophy, Repeat, Edit, RotateCcw, X, CheckCircle, Trash2 } from 'lucide-react'
    ...
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        {games.length === 0 ? (
          ...
          games.map(game => (
            <div key={game.id} className="rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700/60 dark:bg-zinc-900">
